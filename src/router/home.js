...
//
// // 首页
// const Home = r => require.ensure([], () => r(require('../components/home/index')), 'posts_index');
//
// // 招募信息
// import Posts from '../components/posts/posts'
// const Side = r => require.ensure([], () => r(require('../components/posts/side')), 'posts_side');
// const Step = r => require.ensure([], () => r(require('../components/posts/step')), 'posts_step');
//
// // 用户模块
// import User from '../components/user/user'
// const Login = r => require.ensure([], () => r(require('../components/user/login')), 'user_login');
// const Register = r => require.ensure([], () => r(require('../components/user/register')), 'user_login');
// const My = r => require.ensure([], () => r(require('../components/user/my')), 'user_my');
