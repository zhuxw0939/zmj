			...
			if(results.getRedis){
				...
				if(type=="post"){
					request.post({
						...
						form: (obj.form==undefined||obj.form=="") ? obj.data : obj.form,
						...
						// 保存api，仅debug环境
						if(config.debug){
							apiSaves("POST", "servers", config.servers.host+obj.url, (obj.form==undefined||obj.form=="") ? obj.data : obj.form, body, rTime);
						}
					...
					request.get({
						url: config.servers.host+obj.url,
						qs: (obj.form==undefined||obj.form=="") ? obj.data : obj.form
					}, function (error, response, body) {
						...
						// 保存api，仅debug环境
						if(config.debug){
							apiSaves("GET", "servers", config.servers.host+obj.url, (obj.form==undefined||obj.form=="") ? obj.data : obj.form, body, rTime);
						}
